...
Individual-site domains mix four word orders (`brand+city+locksmiths`, `brand+city+locksmith`, `brand+locksmith+city`, `brand+locksmiths+city`) with varied hyphenation (none, fully hyphenated, hyphen after brand) spread evenly across the 126 sites so the fleet shares no single footprint. The `{brand}locksmith(s)-{city}` shape is deliberately excluded. Bundle hubs keep the `{brand}-locksmiths.co.uk` structure.
...
| 16 | Oxford | `latchpeak-locksmiths-oxford.co.uk` | second site vs `oxford.boltfix-locksmiths.co.uk` |
...
| 31 | Gloucester | `boltmate-locksmithgloucester.co.uk` |  |
...
| 47 | Worcester | `boltdash-locksmith-worcester.co.uk` |  |
| 48 | West Bromwich | `latchdash-locksmithswestbromwich.co.uk` |  |
...
| 64 | Nuneaton | `latchgrid-locksmiths-nuneaton.co.uk` |  |
...
| 79 | Bracknell | `boltnode-locksmithbracknell.co.uk` |  |
...
| 95 | Barnsley | `boltrise-locksmith-barnsley.co.uk` |  |
| 96 | Walsall | `latchrise-locksmithswalsall.co.uk` |  |
...
| 112 | Farnborough | `latchsmart-locksmiths-farnborough.co.uk` | second site vs `farnborough.shieldx-locksmiths.co.uk` |
